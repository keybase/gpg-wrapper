...
(function() {
  var BaseKeyRing, BufferOutStream, E, GPG, Globals, GpgKey, KeyRing, Log, MasterKeyRing, TmpKeyRing, TmpKeyRingBase, TmpOneShotKeyRing, TmpPrimaryKeyRing, a_json_parse, athrow, base64u, chain, colgrep, fpeq, fs, globals, gpg, iced, log, make_esc, master_ring, mkdir_p, os, path, prng, states, strip, util, __iced_k, __iced_k_noop, _globals, _ref, _ref1, _ref2,
  ...
  _ref1 = require('pgp-utils').util, fpeq = _ref1.fpeq, athrow = _ref1.athrow, base64u = _ref1.base64u;
  ...
  exports.KeyRing = KeyRing = (function(_super) {
    __extends(KeyRing, _super);

    KeyRing.prototype.to_string = function() {
      return "local ring @ " + this.dir;
    };

    function KeyRing(dir) {
      this.dir = dir;
      KeyRing.__super__.constructor.apply(this, arguments);
    }

    KeyRing.prototype.mutate_args = function(gargs) {
      log().debug("| Mutate GPG args; new args: " + (gargs.args.join(' ')));
      return gargs.args = ["--homedir", this.dir].concat(gargs.args);
    };
  ...
  exports.make_ring = function(d) {
    var klass;
    klass = d != null ? KeyRing : MasterKeyRing;
    return new klass(d);
  };
