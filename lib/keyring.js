...
(function() {
  ...
  exports.BaseKeyRing = BaseKeyRing = (function(_super) {
    ...
    BaseKeyRing.prototype.find_keys_full = function(_arg, cb) {
      var args, consume, d, err, out, query, res, row, rows, secret, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      query = _arg.query, secret = _arg.secret;
