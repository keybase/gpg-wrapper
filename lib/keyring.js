...
(function() {
  var AltKeyRing, AltKeyRingBase, BaseKeyRing, E, GPG, Globals, GpgKey, Log, MasterKeyRing, Parser, TmpKeyRing, TmpKeyRingBase, TmpOneShotKeyRing, TmpPrimaryKeyRing, a_json_parse, athrow, base64u, chain, colgrep, fpeq, fs, globals, gpg, iced, log, make_esc, master_ring, mkdir_p, os, path, pgp_utils, prng, reset_master_ring, states, strip, userid, util, __iced_k, __iced_k_noop, _globals, _ref, _ref1,
  ...
  exports.GpgKey = GpgKey = (function() {
    ...
    GpgKey.prototype.load = function(cb) {
      var args, err, esc, id, l, out, rows, uids, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      id = this.load_id();
          ...
          (function(__iced_k) {
            if (_this.fingerprint() == null) {
              ...
              (function(__iced_k) {
                ...
                return __iced_k((rows.length === 0) || ((_this._fingerprint = rows[0][9]) == null) ? err = new E.GpgError("Couldn't find GPG fingerprint for " + id) : (l = rows.length) > 1 ? err = new E.GpgError("Found more than one (#l) keys for " + id) : (_this._state = states.LOADED, log().debug("- Map " + id + " -> " + _this._fingerprint + " via gpg")));
              });
            } else {
              return __iced_k();
            }
    ...
    GpgKey.prototype.verify_sig = function(_arg, cb) {
      var a, args, b, err, msg, out, payload, sig, which, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
  ...
  exports.BaseKeyRing = BaseKeyRing = (function(_super) {
    ...
    BaseKeyRing.prototype.oneshot_verify = function(_arg, cb) {
      var clean, esc, file, no_json, query, raw, ret, ring, sig, single, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      query = _arg.query, single = _arg.single, sig = _arg.sig, file = _arg.file, no_json = _arg.no_json;
      ring = null;
      clean = function(cb) {
  ...
  AltKeyRingBase = (function(_super) {
    ...
    AltKeyRingBase.prototype.make_empty_pubring = function(cb) {
      var err, f, fd, ok, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      f = this.mkfile("pubring.gpg");
      ...
      (function(_this) {
        return (function(__iced_k) {
          __iced_deferrals = new iced.Deferrals(__iced_k, {
            parent: ___iced_passed_deferral,
            filename: "/Users/max/src/gpg-wrapper/src/keyring.iced",
            funcname: "AltKeyRingBase.make_empty_pubring"
          });
  ...
  exports.AltKeyRing = AltKeyRing = (function(_super) {
    ...
    AltKeyRing.prototype.post_make = function(cb) {
      return this.make_empty_pubring(cb);
    };
  ...
  exports.TmpPrimaryKeyRing = TmpPrimaryKeyRing = (function(_super) {
    ...
    TmpPrimaryKeyRing.prototype.mutate_args = function(gargs) {
      ...
      } else if ((h = globals().get_home_dir()) != null) {
        prepend = ["--no-default-keyring", "--keyring", path.join(h, "pubring.gpg"), "--secret-keyring", path.join(h, "secring.gpg"), "--trustdb-name", path.join(h, "trustdb.gpg")].concat(prepend);
      }
