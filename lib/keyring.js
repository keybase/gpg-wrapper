...
(function() {
  var BaseKeyRing, BufferOutStream, E, GPG, Globals, GpgKey, Log, MasterKeyRing, TmpKeyRing, TmpKeyRingBase, TmpOneShotKeyRing, TmpPrimaryKeyRing, a_json_parse, athrow, base64u, chain, colgrep, fpeq, fs, globals, gpg, iced, log, make_esc, master_ring, mkdir_p, os, path, prng, states, strip, util, __iced_k, __iced_k_noop, _globals, _ref, _ref1, _ref2,
  ...
  exports.BaseKeyRing = BaseKeyRing = (function(_super) {
    ...
    BaseKeyRing.prototype.oneshot_verify = function(_arg, cb) {
      var clean, esc, json, query, raw, ring, sig, single, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      query = _arg.query, single = _arg.single, sig = _arg.sig;
      ring = null;
      clean = function(cb) {
  ...
  exports.TmpOneShotKeyRing = TmpOneShotKeyRing = (function(_super) {
    ...
    TmpOneShotKeyRing.prototype.verify_sig = function(_arg, cb) {
      ...
      (function(_this) {
        return (function(__iced_k) {
          __iced_deferrals = new iced.Deferrals(__iced_k, {
            parent: ___iced_passed_deferral,
            filename: "/Users/max/src/gpg-wrapper/src/keyring.iced",
            funcname: "TmpOneShotKeyRing.verify_sig"
          });
          _this.gpg({
            args: args,
            stdin: sig,
