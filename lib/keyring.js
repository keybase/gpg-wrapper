...
(function() {
  var BaseKeyRing, BufferOutStream, E, GPG, Globals, GpgKey, Log, MasterKeyRing, TmpKeyRing, TmpKeyRingBase, TmpPrimaryKeyRing, athrow, base64u, colgrep, fs, globals, gpg, iced, log, make_esc, master_ring, mkdir_p, path, prng, states, strip, util, __iced_k, __iced_k_noop, _globals, _ref, _ref1,
  ...
  TmpKeyRingBase = (function(_super) {
    ...
    TmpKeyRingBase.prototype.find_keys = function(_arg, cb) {
      ...
      (function(_this) {
        return (function(__iced_k) {
          __iced_deferrals = new iced.Deferrals(__iced_k, {
            parent: ___iced_passed_deferral,
            filename: "/home/max/src/gpg-wrapper/src/keyring.iced",
            funcname: "TmpKeyRingBase.find_keys"
          });
          _this.gpg({
            args: args,
            list_keys: true
