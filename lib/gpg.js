...
(function() {
  ...
  exports.GPG = GPG = (function() {
    ...
    GPG.prototype.read_uids_from_key = function(_arg, cb) {
      var args, col, err, fingerprint, out, query, row, rows, u, uids, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
          ...
          if (typeof err === "undefined" || err === null) {
            ...
            uids = (function() {
              ...
              for (_i = 0, _len = rows.length; _i < _len; _i++) {
                row = rows[_i];
                if (((col = row[9]) != null) && col.length > 0 && ((u = parse(col)) != null)) {
                  _results.push(u);
                }
              }
              return _results;
