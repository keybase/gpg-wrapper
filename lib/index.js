...
(function() {
  var BaseKey, BucketDict, EOL, Element, Ignored, Index, Key, Line, Parser, Subkey, Warnings, parse, pgpu, uniquify, util,
  ...
  BaseKey = (function(_super) {
    ...
    function BaseKey(line) {
      ...
      if (line.v.length < 12) {
        ...
        _ref = line.v, this._pub = _ref[0], this._trust = _ref[1], this._n_bits = _ref[2], this._type = _ref[3], this._key_id_64 = _ref[4], this._created = _ref[5], this._expires = _ref[6];
      }
    }
  ...
  Key = (function(_super) {
    ...
    Key.prototype.add_line = function(line) {
      ...
      if ((n = line.v.length) < 2) {
        ...
        switch ((f = line.v[0])) {
          case 'fpr':
            return this.add_fingerprint(line);
          case 'uid':
    ...
    Key.prototype.add_fingerprint = function(line) {
